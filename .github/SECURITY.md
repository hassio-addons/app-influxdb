...
[**Report a vulnerability**](https://github.com/hassio-addons/app-influxdb/security/advisories/new)
...
- Issues in InfluxDB, Chronograf or Kapacitor themselves; please report those
  directly to [InfluxData](https://github.com/influxdata/influxdb/security/policy).
...
This security policy covers the InfluxDB Home Assistant app published from this
